						...
						<article className={styles.docs_content}>
							<div className={styles.docs_card}>
								...
								<p className={styles.docs_text}>
									Void Presence is an advanced Discord Rich Presence manager
									with customizable button pairs, text cycles, image rotation
									and profile management via drag and drop.
								</p>
								<p className={styles.docs_text}>
							...
							<div className={styles.docs_card}>
								...
								<ul className={styles.docs_list}>
									...
									<li className={styles.docs_list_item}>
										Auto-launch & auto-hide – Optional start on boot and to
										tray.
									</li>
								</ul>
							</div>
							...
							<div className={styles.docs_card}>
								...
								<ol className={styles.docs_list_ordered}>
									...
									<li className={styles.docs_list_item}>
										Click Save to start Rich Presence and use Restart / Stop
										when needed.
									</li>
								</ol>
							</div>
